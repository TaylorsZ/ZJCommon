...
static const void *zs_locationKey;
@implementation UIView (ZSFrame)
-(void)setLocationPoint:(AGSPoint *)locationPoint{
    objc_setAssociatedObject(self, zs_locationKey, locationPoint, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
-(AGSPoint *)locationPoint{
    return objc_getAssociatedObject(self, zs_locationKey);
}
